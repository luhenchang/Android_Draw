 ...
 */
public class LHC_Scroll_LineView extends View {
    //xy坐标轴颜色
    ...
    public LHC_Scroll_LineView(Context context) {
        this(context, null);
    }

    public LHC_Scroll_LineView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LHC_Scroll_LineView(Context context, AttributeSet attrs, int defStyleAttr) {
